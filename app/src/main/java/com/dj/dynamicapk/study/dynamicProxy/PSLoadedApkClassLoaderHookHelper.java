...
public class PSLoadedApkClassLoaderHookHelper {
    public static Map<String,Object> sLoadedApk = new HashMap<>();
    public static void hookLoadedApkInActivityThread(File apkFile) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
