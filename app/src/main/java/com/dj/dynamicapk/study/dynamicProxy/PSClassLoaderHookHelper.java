...
public class PSClassLoaderHookHelper {
    /**
     * 从插件apk文件中，得到dexElements，将dexElements合并到宿主apk中
     * @param context 上下文
     * @param pluginApkPath 插件apk的完整路径
     */
    public static void loadClass(Context context, String pluginApkPath) {
    ...
    /**
     * 从dex文件中，得到dexElements，将dexElements合并到宿主apk中
     * @param classLoader 类加载器
     * @param outDexFilePath dex所在的完整路径
     * @param optimizedDirectory 指的是优化后的 dex 存放目录
     */
